...
| 当前提交 `b8a6fff` 的 Quality workflow | PASS | [run 31298415711](https://github.com/FlanChanXwO/pixiv-cli/actions/runs/31298415711)；在 feature ref 手动 dispatch，Classify、Windows login handler contracts 与 quality gate 均成功；仅有 Node.js 20 action deprecation annotation。 |
...
| 提交 `3e8cff9` 的 Quality workflow（2026-08-09 continuation） | PASS | [run 31307499216](https://github.com/FlanChanXwO/pixiv-cli/actions/runs/31307499216) 的 Classify、Windows login handler contracts 与 quality job 全部成功；仅有既有 Node.js 20 action deprecation annotation。workflow 未运行真实 FANBOX credential、浏览器或发版步骤。 |
