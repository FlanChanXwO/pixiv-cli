...
> 本文件覆盖 `G1-T01`、`G1-T02`、`G1-T03`、`G1-CHECK-01`、`G1-T04`、`G1-T05`、`G1-T06`、`G1-CHECK-02`、`G1-T07`、`G1-T08`、`G1-T09`、`G1-CHECK-03`、`G1-T10`、`G1-T11`、`G1-T12`、`G1-CHECK-04`、`G1-T13`、`G1-T14`、`G1-T15`、`G1-CHECK-05`、`G1-T16`、`G1-T17`、`G1-T18`、`G1-CHECK-06`、`G1-T19`、`G1-T20`、`G1-T21`、`G1-CHECK-07`、`G1-T22`、`G1-T23`、`G1-T24`、`G1-CHECK-08`、`G1-T25`、`G1-T26`、`G1-T27`、`G1-CHECK-09` 与 `G1-T28`，只记录当前分支的代码、测试、历史和 Goal-3 证据，不授予任何 capability 的发布资格。
...
| 11 | `novel-recommended` | implemented_unverified | verified | verified | verified | verified | verified | verified | implemented_unverified | implemented_unverified | missing |
