...
- **Live 失败 → correction：** #16/#20 absent case live `malformed_upstream_response`（响应 200 + is_bookmarked:false + 作品 tags；adapter 过严与冻结契约冲突）；注册 `G1-CORR-G1-T29-BOOKMARK-DETAIL-01`。
- **Live verdict 更新：** #14/#15/#18/#19/#23/#24/#29/#30/#31/#32/#33/#34/#35/#37 Live → verified；#27 Live=blocked_external (data)；#16/#20 保持未验证（correction owner）。
- **Correction：** G1-CORR-G1-T29-BOOKMARK-DETAIL-01（pending，抢占下一轮）。**下一步：** G1-CORR-G1-T29-BOOKMARK-DETAIL-01。
