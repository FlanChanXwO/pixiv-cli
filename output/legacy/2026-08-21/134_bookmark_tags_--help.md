# Inspect bookmark tags --help syntax

## Command
```shell
cd /private/tmp/pixiv-cli-e2e-shell-20260821 && ./bin/pixiv bookmark tags --help
```

## Output
```text
List artwork bookmark tags

Usage:
  pixiv bookmark tags [USER_ID] [flags]
...
Flags:
  ...
  -t, --type string       entity type: artwork (default "artwork")
```
