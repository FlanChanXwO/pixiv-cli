...
```zsh
/private/tmp/pixiv-cli-e2e-shell-20260821/bin/pixiv timeline following --type novel --limit 3 --json --proxy http://127.0.0.1:7890
```

## Expected result

Pixiv returns a valid novel timeline document, including an empty result when the account follows none.
