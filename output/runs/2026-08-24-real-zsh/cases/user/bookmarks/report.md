# List discovered user public bookmarks
...
```zsh
/private/tmp/pixiv-cli-e2e-shell-20260821/bin/pixiv user bookmarks 7621567 --limit 3 --json --proxy http://127.0.0.1:7890
```

## Expected result

Pixiv returns up to three public bookmarks for user 7621567.
