# Fetch discovered user through user detail
...
```zsh
/private/tmp/pixiv-cli-e2e-shell-20260821/bin/pixiv user detail 7621567 --json --proxy http://127.0.0.1:7890
```

## Expected result

Pixiv returns the complete profile for user 7621567.

## Assertion

Exit code is 0; JSON user ID is 7621567.
