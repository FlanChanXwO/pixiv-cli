...
```zsh
/private/tmp/pixiv-cli-e2e-shell-20260821/bin/pixiv user artworks 7621567 --limit 3 --json --proxy http://127.0.0.1:7890
```

## Expected result

Pixiv returns up to three artworks for user 7621567.
