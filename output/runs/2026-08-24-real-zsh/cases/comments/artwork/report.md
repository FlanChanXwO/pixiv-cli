# List comments for discovered artwork
...
```zsh
/private/tmp/pixiv-cli-e2e-shell-20260821/bin/pixiv comment 148810634 --type artwork --limit 3 --json --proxy http://127.0.0.1:7890
```

## Expected result

Pixiv returns up to three comments for artwork 148810634, including an empty list.
