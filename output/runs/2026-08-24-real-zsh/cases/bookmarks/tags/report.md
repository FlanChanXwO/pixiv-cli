# List current artwork bookmark tags
...
```zsh
/private/tmp/pixiv-cli-e2e-shell-20260821/bin/pixiv bookmark tags --type artwork --limit 3 --json --proxy http://127.0.0.1:7890
```

## Expected result

Pixiv returns current-account artwork bookmark tags, including an empty list.

## Assertion

Exit code is 0; stdout is valid JSON with a tags collection.
