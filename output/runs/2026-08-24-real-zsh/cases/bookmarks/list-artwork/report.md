# List current artwork bookmarks
...
```zsh
/private/tmp/pixiv-cli-e2e-shell-20260821/bin/pixiv bookmark list --type artwork --limit 3 --json --proxy http://127.0.0.1:7890
```

## Expected result

Pixiv returns up to three current-account artwork bookmarks.

## Assertion

Exit code is 0; stdout is valid JSON with an artwork bookmark collection.
