# List users followed by current account
...
```zsh
/private/tmp/pixiv-cli-e2e-shell-20260821/bin/pixiv user following --limit 3 --json --proxy http://127.0.0.1:7890
```

## Expected result

Pixiv returns the current account following list, including an empty list.

## Assertion

Exit code is 0; stdout is valid JSON with a user collection.
