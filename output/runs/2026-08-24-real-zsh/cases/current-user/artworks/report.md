...
```zsh
/private/tmp/pixiv-cli-e2e-shell-20260821/bin/pixiv user artworks --limit 3 --json --proxy http://127.0.0.1:7890
```

## Expected result

Pixiv returns the current account artwork list, including an empty list.
