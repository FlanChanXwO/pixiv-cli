...
```zsh
/private/tmp/pixiv-cli-e2e-shell-20260821/bin/pixiv user novels --limit 3 --json --proxy http://127.0.0.1:7890
```

## Expected result

Pixiv returns the current account novel list, including an empty list.
