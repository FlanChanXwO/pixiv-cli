...
```zsh
/private/tmp/pixiv-cli-e2e-shell-20260821/bin/pixiv user search miku --limit 3 --json --proxy http://127.0.0.1:7890
```

## Expected result

Pixiv returns up to three current user results.

## Assertion

Exit code is 0; JSON has a non-empty user_previews array with positive user IDs.
