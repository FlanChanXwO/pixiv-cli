# Fetch current artwork trending tags
...
```zsh
/private/tmp/pixiv-cli-e2e-shell-20260821/bin/pixiv search --trending-tags --json --proxy http://127.0.0.1:7890
```

## Expected result

Pixiv returns the current complete trending-tag document.

## Assertion

Exit code is 0; JSON contains a non-empty tags array with artwork samples.
