...
```zsh
/private/tmp/pixiv-cli-e2e-shell-20260821/bin/pixiv recommended user --limit 3 --json --proxy http://127.0.0.1:7890
```

## Expected result

Pixiv returns up to three personalized user recommendations.

## Assertion

Exit code is 0; JSON contains a user recommendation collection.
