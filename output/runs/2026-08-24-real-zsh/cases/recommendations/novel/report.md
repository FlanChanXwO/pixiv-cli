...
```zsh
/private/tmp/pixiv-cli-e2e-shell-20260821/bin/pixiv recommended novel --limit 3 --json --proxy http://127.0.0.1:7890
```

## Expected result

Pixiv returns up to three personalized novel recommendations.

## Assertion

Exit code is 0; JSON contains a novel recommendation collection.
