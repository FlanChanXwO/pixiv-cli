...
func openLockFile(path string) (*os.File, error) {
	...
	if err := os.MkdirAll(directory, PrivateDirMode); err != nil {
		return nil, err
	}
	if err := os.Chmod(directory, PrivateDirMode); err != nil {
		return nil, err
	}
	file, err := os.OpenFile(path+".lock", os.O_CREATE|os.O_RDWR, PrivateFileMode)
	if err != nil {
		return nil, err
	}
