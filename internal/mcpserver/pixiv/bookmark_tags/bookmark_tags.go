...
func handleBookmarkTags(ctx context.Context, app *runtime.App, in In) (*mcp.CallToolResult, outputs.BookmarkTags, error) {
	...
	items, more, err := runtime.CollectPooledPages(ctx, app, plan, func(ctx context.Context, client *pixiv.Client, cursor sdk.Cursor) ([]pixiv.BookmarkTag, sdk.Cursor, error) {
