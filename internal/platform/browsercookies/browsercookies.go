...
// （chrome/chromium、edge、firefox、safari）。本包不识别 Cloudflare challenge，
// 也不运行任何 challenge 绕过；它只读取 cookie。
package browsercookies

import (
	// 导入 provider 子包触发 init 注册，使 core.New 可分发全部浏览器。
	_ "github.com/FlanChanXwO/pixiv-cli/internal/platform/browsercookies/chromium"
	_ "github.com/FlanChanXwO/pixiv-cli/internal/platform/browsercookies/firefox"
	_ "github.com/FlanChanXwO/pixiv-cli/internal/platform/browsercookies/safari"
...
// New 按浏览器名称创建 provider：支持 "chrome"/"chromium"、"edge"、
