...
type AccountStore interface {
	ImportAccount(context.Context, string, bool) (Account, error)
	...
	RefreshAccount(context.Context, int64) (Account, error)
	CurrentUser(context.Context) (*Account, error)
	RestoreAccount(context.Context, Account, string, bool) error
...
func (s AccountService) ImportBundle(body []byte) (AccountBundleImportResult, error) {
	...
	for _, account := range bundle.Accounts {
		restoredAccount := Account{UserID: account.UserID, Username: account.Username}
...
func accountResultFromPixiv(account Account) AccountResult {
...
func accountImportResult(account Account, status string) AccountImportResult {
