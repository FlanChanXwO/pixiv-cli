...
func ReadPixivDefaultUserID() (userID int64, ok bool, err error) {
	return (ConfigFileStore{Files: defaultFileStore{}}).ReadPixivDefaultUserID()
}

// ReadPixivDefaultUserID 从注入的配置文件端口读取默认账号 UID。
func (s ConfigFileStore) ReadPixivDefaultUserID() (userID int64, ok bool, err error) {
...
func SetPixivDefaultUserID(userID int64) error {
	return (ConfigFileStore{Files: defaultFileStore{}}).SetPixivDefaultUserID(userID)
}

// SetPixivDefaultUserID 写入注入的配置文件端口。
func (s ConfigFileStore) SetPixivDefaultUserID(userID int64) error {
...
func ClearPixivDefaultUserID() error {
	return (ConfigFileStore{Files: defaultFileStore{}}).ClearPixivDefaultUserID()
}

func (s ConfigFileStore) ClearPixivDefaultUserID() error {
...
func ReadFanboxDefaultUserID() (userID int64, ok bool, err error) {
	return (ConfigFileStore{Files: defaultFileStore{}}).ReadFanboxDefaultUserID()
}

func (s ConfigFileStore) ReadFanboxDefaultUserID() (userID int64, ok bool, err error) {
...
func SetFanboxDefaultUserID(userID int64) error {
	return (ConfigFileStore{Files: defaultFileStore{}}).SetFanboxDefaultUserID(userID)
}

func (s ConfigFileStore) SetFanboxDefaultUserID(userID int64) error {
...
func ClearFanboxDefaultUserID() error {
	return (ConfigFileStore{Files: defaultFileStore{}}).ClearFanboxDefaultUserID()
}

func (s ConfigFileStore) ClearFanboxDefaultUserID() error {
...
func (s ConfigFileStore) readDefaultUserID(sectionKey string) (int64, bool, error) {
	path, err := s.Path()
	if err != nil {
		return 0, false, err
	}
	...
	state, err := LoadSettingsStateAtWithFileStore(path, files)
	if err != nil {
		return 0, false, err
	}
...
func (s ConfigFileStore) writeDefaultUserID(sectionKey string, userID int64) error {
	if userID <= 0 {
...
func (s ConfigFileStore) clearDefaultUserID(sectionKey string) error {
	path, err := s.Path()
	if err != nil {
		return err
	}
