...
func (a controller) waitForHandoffRelayLoginCode(ctx context.Context, opts loginRelayServerOptions, acceptsCallback callbackURLAccepter, loginURL string) (string, func(bool), func(), error) {
