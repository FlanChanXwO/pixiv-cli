...
func ActiveRemoteLoginPath() (string, error) {
	return localstate.UserDataFile(localstate.AppDataDirName, activeHandoffFilename)
}
...
func SaveActiveRemoteLoginAt(statePath string, session ActiveRemoteLogin) error {
	...
	return filesecret.WritePrivateFile(statePath, body, localstate.PrivateFileMode)
}
