...
func (a command) run(cmd *cobra.Command, arg string, opts options) error {
	...
	switch entity {
	case "artwork":
		result, err := deps.Read(a.data, cmd.Context(), request, func(ctx context.Context, client *pixiv.Client) (pixiv.Artwork, error) {
	...
	case "novel":
		if opts.content {
			result, err := deps.Read(a.data, cmd.Context(), request, func(ctx context.Context, client *pixiv.Client) (pixiv.NovelContent, error) {
		...
		result, err := deps.Read(a.data, cmd.Context(), request, func(ctx context.Context, client *pixiv.Client) (pixiv.Novel, error) {
