...
import (
	...
	statelock "github.com/FlanChanXwO/pixiv-cli/internal/storage/localstate"
...
func activeRemoteLoginPath() (string, error) {
	return files.UserDataFile(constants.AppDataDirName, activeHandoffFilename)
}
...
func saveActiveRemoteLoginAt(statePath string, session activeRemoteLogin) error {
	...
	return files.WritePrivateFile(statePath, body, constants.PrivateFileMode)
}
