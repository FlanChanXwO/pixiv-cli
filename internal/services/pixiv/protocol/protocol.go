...
const (
	...
	AppIllustCommentAdd      = "/v1/illust/comment/add"
	AppIllustCommentDelete   = "/v1/illust/comment/delete"
	AppNovelComments         = "/v2/novel/comments"
	AppNovelCommentAdd       = "/v1/novel/comment/add"
	AppNovelCommentDelete    = "/v1/novel/comment/delete"
	AppStamps                = "/v1/stamps"
