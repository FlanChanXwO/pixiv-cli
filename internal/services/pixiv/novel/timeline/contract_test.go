...
import (
	...
	"github.com/FlanChanXwO/pixiv-cli/internal/services/pixiv/novel/timeline"
)
...
func TestTimelineMapsConfirmedRoutesAndQueries(t *testing.T) {
	tests := []struct {
		...
		{name: "latest", request: timeline.Request{Kind: timeline.Latest, Offset: 30}, path: "/v1/novel/new", query: map[string]string{"filter": "for_android", "offset": "30"}},
